...
mnalias=$(find /root/.cryptocurrency_* -maxdepth 0 -type d | cut -c23- | head -n 1)
...
echo "Commands:"
echo "MNALIAS_start"
echo "MNALIAS_restart"
echo "MNALIAS_status"
echo "MNALIAS_stop"
echo "MNALIAS_config"
echo "MNALIAS_getinfo"
echo "MNALIAS_getpeerinfo"
echo "MNALIAS_resync"
echo "MNALIAS_reindex"
fi
